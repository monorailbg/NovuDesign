...
function ProjectCard({ p, i }: { p: typeof projects[0]; i: number }) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -top-16 -right-16 w-64 h-64 rounded-full blur-3xl transition-all duration-700"
        style={{ background:p.color, opacity:hov?0.14:0.05 }} />
      <div className="absolute -bottom-10 -left-10 w-48 h-48 rounded-full blur-3xl transition-all duration-700"
